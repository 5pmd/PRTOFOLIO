...
{
    [TestFixture]
    internal class NormalSpeedGeneratorTests
    {
        ...
        public void SetUp()
        {
            _speedGenerator = new NormalSpeedGenerator();
        }

        [Test]
        public async Task GenerateSpeedAsync_ShouldGenerate200()
        {
            var expectedSpeed = 200;
            var speed = 0;
